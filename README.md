...
|------|-------------|------|---------|:--------:|
| <a name="input_create_namespace"></a> [create\_namespace](#input\_create\_namespace) | Set this true to create a new namespace in region set by provider. | `bool` | `true` | no |
